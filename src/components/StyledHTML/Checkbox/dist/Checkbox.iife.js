var Checkbox = (function (exports) {
  ...
  var CheckboxContainer = styled.div(_templateObject$1());
  var CheckboxAligner = styled.div(_templateObject2$1());
  var SymbolHolder = styled("div", props$1)(_templateObject3$1(), function (props) {
    return props.disabled ? "\n    cursor: not-allowed;\n    & div {\n      color: #b6b6b6;\n    }\n  " : "\n    cursor: pointer;\n    & div:hover {\n      color: #496cbd;\n    }\n  ";
  });
  var SvgHolder = styled("svg", props$1)(_templateObject4$1(), function (props) {
  ...
  /* script */
  const __vue_script__$1 = Checkbox;
  ...
  var install = function installCheckbox(Vue) {
    if (install.installed) return;
    install.installed = true;
    Vue.component("Checkbox", __vue_component__$1);
  }; // Create module definition for Vue.use()
...
//# sourceMappingURL=Checkbox.iife.js.map
