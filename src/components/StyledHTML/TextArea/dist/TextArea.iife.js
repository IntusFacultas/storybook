var TextArea = (function() {
  ...
  */
  ...
  DragResize.prototype.resizeHandleSet = function(elm, show) {
    if (!elm._handle_tr) {
      for (var h = 0; h < this.handles.length; h++) {
        ...
        hDiv.className =
          this.myName + " " + this.myName + "-" + this.handles[h];
  ...
  var NTextArea = styled("textarea", props$1)(
    _templateObject$1(),
    function(props) {
  ...
  const __vue_inject_styles__$1 = function(inject) {
    if (!inject) return;
    inject("data-v-e6819fb8_0", {
      source:
        "\n.input-container {\r\n  display: flex;\r\n  flex-direction: column;\r\n  width: 100%;\n}\r\n",
      map: {
        version: 3,
        sources: [
          "C:\\Users\\pedro\\Documents\\Personal Projects\\GitHub\\storybook\\storybook\\src\\components\\StyledHTML\\TextArea\\src\\TextArea.vue"
        ],
        names: [],
        mappings: ";AAsMA;EACA,aAAA;EACA,sBAAA;EACA,WAAA;AACA",
        file: "TextArea.vue",
        sourcesContent: [
