var Table = (function (exports) {
  ...
  var DialogButton = styled$1("button", dialogProps)(_templateObject(), function (props) {
  ...
  var NButton = styled$1("button", props)(_templateObject2(), function (props) {
    return props.large ? "8px 10px" : props.small ? "3px 5px" : "5px 10px";
  }, function (props) {
    return props.large ? "24px" : props.small ? "12px" : "16px";
  }, function (props) {
  ...
  var NTable = styled("table", props$1)(_templateObject$1(), function (props) {
  ...
  var TableCarat = styled("div", props$1)(_templateObject2$1(), function (props) {
    return props.theme && props.theme[props.flavor] ? props.theme[props.flavor].color.color : props.defaultTheme[props.flavor] ? props.defaultTheme[props.flavor].color.color : "#222";
  });
  var TableHeaders = styled("thead", props$1)(_templateObject3());
  var TableBody = styled("tbody", props$1)(_templateObject4());
  var TableRow = styled("tr", props$1)(_templateObject5());
  var TableHeader = styled("th", props$1)(_templateObject6(), function (props) {
  ...
  var TableCell = styled("td", props$1)(_templateObject7(), function (props) {
    return props.condensed ? "padding: .25rem;" : "padding: .5rem;";
  }, function (props) {
    return props.textAlign ? props.textAlign : "left";
  }, function (props) {
  ...
  /* script */
  const __vue_script__$1 = VueTable;
