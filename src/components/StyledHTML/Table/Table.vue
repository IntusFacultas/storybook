    ...
    <n-thead>
      <n-tr>
        ...
        >
          ...
          <table-carat
            :flavor="headerFlavor ? headerFlavor : flavor"
            :class="sort == header.key ? '': sort == '-' + header.key ? 'table-open-carat' : 'table-not-shown'"
          ></table-carat>
        </n-th>
      </n-tr>
    </n-thead>
    <n-tbody>
      ...
      >
        <n-td
          ...
          :condensed="condensed"
          :bordered="bordered"
        >{{item.data.id ? item.data.id : item.data.pk ? item.data.pk : index + 1}}</n-td>
        <n-td
...
`;
export const NThead = styled("thead", props)``;
export const NTbody = styled("tbody", props)``;
export const NTr = styled("tr", props)``;
export const NTh = styled("th", props)`
    ...
    border-color: ${props =>
      props.theme && props.theme[props.flavor]
        ...
        : "#d9d9d9"};
`;
export const NTd = styled("td", props)`
    ${props => (props.condensed ? `padding: .25rem;` : `padding: .5rem;`)}
    text-align: ${props => (props.textAlign ? props.textAlign : "left")};
    ${props =>
      props.bordered
...
export const VueTable = {
  components: { NTable, NThead, NTbody, NTr, NTh, NTd, TableCarat },
  data() {
    return {
      sort: ""
    };
