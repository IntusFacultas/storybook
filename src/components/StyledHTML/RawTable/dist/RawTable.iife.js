var RawTable = (function () {
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c("n-table", {
    ...
    }, [_c("table-headers", [_c("table-row", [_vm.numbered ? _c("table-header", {
      attrs: {
      ...
      return _c("table-header", {
        ...
        class: _vm.sort == header.key ? "" : _vm.sort == "-" + header.key ? "table-open-carat" : "table-not-shown",
        attrs: {
          flavor: _vm.headerFlavor ? _vm.headerFlavor : _vm.flavor
        }
      })], 1);
    })], 2)], 1), _vm._v(" "), _c("table-body", _vm._l(_vm.items, function (item, index) {
      return _c("table-row", {
        key: "item" + index,
        class: {
      ...
      }, [_vm._v(_vm._s(item.data.id ? item.data.id : item.data.pk ? item.data.pk : index + 1))]) : _vm._e(), _vm._v(" "), _vm._l(_vm.tableHeaders, function (header) {
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-29ba1314_0", {
      ...
      map: {
        "version": 3,
        "sources": ["C:\\Users\\pedro\\Documents\\Personal Projects\\GitHub\\storybook\\storybook\\src\\components\\StyledHTML\\Table\\src\\Table.vue"],
        "names": [],
        "mappings": ";AAiWA;EACA,UAAA;EACA,mCAAA;AACA;AACA;EACA,qCAAA;AACA;AAEA;EACA,oCAAA;AACA",
        "file": "Table.vue",
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-0f35630b_0", { source: "\n.table-not-shown {\r\n  opacity: 0;\r\n  transform: rotate(45deg) !important;\n}\n.table-hoverable-row:hover {\r\n  background-color: rgba(0, 0, 0, 0.05);\n}\n.table-open-carat {\r\n  transform: rotate(135deg) !important;\n}\r\n", map: {"version":3,"sources":["C:\\Users\\pedro\\Documents\\Personal Projects\\GitHub\\storybook\\storybook\\src\\components\\StyledHTML\\RawTable\\src\\RawTable.vue"],"names":[],"mappings":";AA+BA;EACA,UAAA;EACA,mCAAA;AACA;AACA;EACA,qCAAA;AACA;AAEA;EACA,oCAAA;AACA","file":"RawTable.vue","sourcesContent":["<template>\r\n  <n-table :flavor=\"flavor\" :striped=\"striped\">\r\n    <table-headers>\r\n      <slot name=\"header\"> </slot>\r\n    </table-headers>\r\n    <table-body>\r\n      <slot name=\"body\"> </slot>\r\n    </table-body>\r\n  </n-table>\r\n</template>\r\n\r\n<script>\r\nimport { NTable, TableHeaders, TableBody } from \"@IntusFacultas/table\";\r\n\r\nexport const VueRawTable = {\r\n  components: { NTable, TableHeaders, TableBody },\r\n  props: {\r\n    flavor: {\r\n      type: String,\r\n      default: \"\"\r\n    },\r\n    striped: {\r\n      type: Boolean,\r\n      default: false\r\n    }\r\n  }\r\n};\r\nexport default VueRawTable;\r\n</script>\r\n\r\n<style>\r\n.table-not-shown {\r\n  opacity: 0;\r\n  transform: rotate(45deg) !important;\r\n}\r\n.table-hoverable-row:hover {\r\n  background-color: rgba(0, 0, 0, 0.05);\r\n}\r\n\r\n.table-open-carat {\r\n  transform: rotate(135deg) !important;\r\n}\r\n</style>\r\n"]}, media: undefined });
