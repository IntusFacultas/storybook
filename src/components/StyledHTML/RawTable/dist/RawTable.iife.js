var RawTable = (function (exports) {
  ...
  var generateAlphabeticName$1 = function generateAlphabeticName(code) {
    ...
    return code > chars$1.length ? "".concat(generateAlphabeticName(Math.floor(code / chars$1.length))).concat(lastDigit) : lastDigit;
  };
  ...
  function isPlainObject$1(value) {
    if (!isObjectLike$1(value) || objectToString$1.call(value) != objectTag$1 || isHostObject$1(value)) {
      return false;
    }
  ...
  var objToCss$1 = function objToCss(obj, prevKey) {
    var css = Object.keys(obj).map(function (key) {
      ...
      return "".concat(hyphenateStyleName_1$1(key), ": ").concat(obj[key], ";");
    }).join(' ');
    return prevKey ? "".concat(prevKey, " {\n  ").concat(css, "\n}") : css;
  };
  ...
  var flatten$1 = function flatten(chunks, executionContext) {
    return chunks.reduce(function (ruleSet, chunk) {
      ...
      return ruleSet.concat(lodash_isplainobject$1(chunk) ? objToCss$1(chunk) : chunk.toString());
    }, []);
  };
  ...
  var StyleSheet$2 = function () {
    function StyleSheet() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$maxLength = _ref.maxLength,
          maxLength = _ref$maxLength === void 0 ? isBrowser$1 && oldIE$1 ? 4000 : 65000 : _ref$maxLength;
    ...
    _createClass$1(StyleSheet, [{
      ...
      value: function rules() {
        ...
        var arr = [];
        this.tags.forEach(function (tag) {
          return arr.splice.apply(arr, [arr.length, 0].concat(_toConsumableArray$1(Array.from(sheetForTag$1(tag).cssRules))));
        });
        return arr;
      }
    }]);
  ...
  function assignValue$1(object, key, value) {
    ...
    if (!(hasOwnProperty$1$1.call(object, key) && eq$1(objValue, value)) || value === undefined && !(key in object)) {
      object[key] = value;
    }
  }
  /**
    ...
    var createStyledComponent = function createStyledComponent(target, rules, props) {
      ...
      var StyledComponent = {
        ...
        render: function render(createElement) {
          ...
          return createElement(isVueComponent$1(target) ? target : this.$props.as || target, {
            "class": [this.generatedClassName],
            props: this.$props,
            domProps: {
              value: this.localValue
        ...
        extend: function extend(cssRules) {
          ...
          var extendedRules = css$1.apply(void 0, [cssRules].concat(interpolations));
          return createStyledComponent(target, rules.concat(extendedRules), props);
        },
        withComponent: function withComponent(newTarget) {
          return createStyledComponent(newTarget, rules, props);
  ...
  var _componentStyle$1 = function _componentStyle(nameGenerator) {
    ...
    var ComponentStyle = function () {
      ...
      _createClass$1(ComponentStyle, [{
        key: "generateAndInjectStyles",
        value: function generateAndInjectStyles(executionContext) {
          var flatCSS = flatten$1(this.rules, executionContext).join('').replace(/^\s*\/\/.*$/gm, '');
  ...
  function isValidElementType$1(target) {
    return isStyledComponent$1(target) || isVueComponent$1(target) || isTag$1(target);
  }
  ...
  var _styled$1 = function _styled(createStyledComponent) {
    var styled = function styled(tagName) {
      ...
      return function (cssRules) {
        ...
        return createStyledComponent(tagName, css$1.apply(void 0, [cssRules].concat(interpolations)), props);
      };
    };
  ...
  var styled$1 = _styled$1(_styledComponent$1(_componentStyle$1(generateAlphabeticName$1)));
  ...
  var AlertTheme$1 = {
    Warning: Theme$2["Warning"],
    Danger: Theme$2["Danger"],
    Success: Theme$2["Success"],
    Info: Theme$2["Info"]
  };
  var Theme$2 = Object.assign(Theme$2, NIWSTheme$1, AlertTheme$1);
  var Theme$3 = Theme$2;
  ...
  var ButtonGroup = styled$1.div(_templateObject());
  var DialogButton = styled$1("button", dialogProps)(_templateObject2(), function (props) {
  ...
  var NButton = styled$1("button", props)(_templateObject3(), function (props) {
    return props.large ? "8px 10px" : props.small ? "3px 5px" : "5px 10px";
  }, function (props) {
    return props.large ? "24px" : props.small ? "12px" : "16px";
  }, function (props) {
  ...
  var PageTitle = styled("h1", titleProps)(_templateObject$1(), function (props) {
  ...
  var TextContent = styled("span", props$1)(_templateObject2$1(), function (props) {
  ...
  var Paragraph = TextContent.withComponent("p", props$1);
  var SmallText = styled("small", props$1)(_templateObject3$1(), function (props) {
    return props.bold ? "bold" : 500;
  }, function (props) {
    return props.dark ? props.textTheme.Dark.color : props.textTheme.Normal.color;
  }, function (props) {
  ...
  var NLabel = TextContent.withComponent("label", props$1);
  var WebLink = TextContent.withComponent("a", props$1);
  ...
  var __vue_script__$1 = TextContent;
  /* template */
  ...
  var __vue_component__$1 = normalizeComponent$1({}, __vue_inject_styles__$1, __vue_script__$1, __vue_scope_id__$1, __vue_is_functional_template__$1, __vue_module_identifier__$1, false, createInjector, undefined, undefined);
  ...
  var NTable = styled("table", props$2)(_templateObject$2(), function (props) {
  ...
  var TableCarat = styled("div", props$2)(_templateObject2$2(), function (props) {
    return props.theme && props.theme[props.flavor] ? props.theme[props.flavor].color.color : props.defaultTheme[props.flavor] ? props.defaultTheme[props.flavor].color.color : "#222";
  });
  var TableHeaders = styled("thead", props$2)(_templateObject3$2());
  var TableBody = styled("tbody", props$2)(_templateObject4());
  var TableRow = styled("tr", props$2)(_templateObject5(), function (props) {
    return props.hover ? "\n      &:hover {\n        background-color: rgb(0,0,0,0.05);\n      }" : "";
  });
  var TableHeader = styled("th", props$2)(_templateObject6(), function (props) {
  ...
  var TableCell = styled("td", props$2)(_templateObject7(), function (props) {
    return props.condensed ? "padding: .25rem;" : "padding: .5rem;";
  }, function (props) {
    return props.textAlign ? props.textAlign : "left";
  }, function (props) {
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c("n-table", {
    ...
    }, [_c("table-headers", [_vm._l(_vm.tableTitles, function (title, index) {
      return _c("table-row", {
        key: "title" + index
      }, [_c("table-header", {
        attrs: {
          ...
          "text-align": "center",
          colspan: _vm.numbered && _vm.selectable ? _vm.tableHeaders.length + 2 : _vm.numbered || _vm.selectable ? _vm.tableHeaders.length + 1 : _vm.tableHeaders.length
        }
      }, [_c("text-content", {
        attrs: {
          bold: true
    ...
    }), _vm._v(" "), _c("table-row", [_vm.numbered ? _c("table-header", {
      attrs: {
        flavor: _vm.headerFlavor ? _vm.headerFlavor : _vm.flavor,
        condensed: _vm.condensed,
        bordered: _vm.bordered,
    ...
    }, [_vm._v("#")]) : _vm._e(), _vm._v(" "), _vm._l(_vm.tableHeaders, function (header, index) {
      return _c("table-header", {
        key: "header" + index,
        attrs: {
          flavor: _vm.headerFlavor ? _vm.headerFlavor : _vm.flavor,
          condensed: _vm.condensed,
      ...
      }, [_vm._v(_vm._s(header.text))]), _vm._v(" "), _c("table-carat", {
        class: _vm.internalSort == header.key ? "" : _vm.internalSort == "-" + header.key ? "table-open-carat" : "table-not-shown",
        attrs: {
          flavor: _vm.headerFlavor ? _vm.headerFlavor : _vm.flavor
        }
      })], 1);
    }), _vm._v(" "), _vm.selectable ? _c("table-header", {
      attrs: {
        flavor: _vm.headerFlavor ? _vm.headerFlavor : _vm.flavor,
        condensed: _vm.condensed,
        bordered: _vm.bordered,
    ...
    }, [_vm._v(" ")]) : _vm._e()], 2)], 2), _vm._v(" "), _c("table-body", [_c("table-row", {
      directives: [{
        name: "show",
        rawName: "v-show",
    ...
    })])])], 1), _vm._v(" "), _vm._l(_vm.items, function (item, index) {
      return _c("table-row", {
        directives: [{
          name: "show",
          rawName: "v-show",
      ...
      }, [_vm.numbered ? _c("table-cell", {
        attrs: {
          flavor: _vm.flavor,
          condensed: _vm.condensed,
          bordered: _vm.bordered
        }
      }, [_vm._v("\n        " + _vm._s(item.data.id ? item.data.id : item.data.pk ? item.data.pk : index + 1) + "\n      ")]) : _vm._e(), _vm._v(" "), _vm._l(_vm.tableHeaders, function (header) {
        ...
        }, [_c("text-content", [_vm._v("\n          " + _vm._s(item.data[header.key]) + "\n        ")])], 1);
      }), _vm._v(" "), _vm.selectable ? _c("table-cell", {
        attrs: {
          flavor: _vm.flavor,
          condensed: _vm.condensed,
          bordered: _vm.bordered
        }
      }, [_vm.buttons.length == 1 ? _c("div", _vm._l(_vm.buttons, function (button, index) {
        return _c("n-button", {
          key: "button" + index,
          attrs: {
            small: _vm.condensed,
      ...
      }), 1) : _c("button-group", _vm._l(_vm.buttons, function (button, index) {
        return _c("n-button", {
          key: "button" + index,
          attrs: {
            small: _vm.condensed,
  ...
  var __vue_inject_styles__$2 = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-22828e9a_0", {
      ...
      map: {
        "version": 3,
        "sources": ["C:\\Users\\pedro\\Documents\\Personal Projects\\GitHub\\storybook\\src\\components\\StyledHTML\\Table\\src\\Table.vue"],
        "names": [],
        "mappings": ";AAkiBA;EACA,UAAA;EACA,mCAAA;AACA;AACA;EACA,qCAAA;AACA;AAEA;EACA,oCAAA;AACA;AACA;EACA,aAAA;EACA,8BAAA;AACA;AACA;AACA;IACA,+BAAA;AACA;AACA;AACA;AACA;IACA,kCAAA;AACA;AACA;AACA;AACA;IACA,0BAAA;AACA;AACA;AAEA;EACA,8CAAA;AACA",
        "file": "Table.vue",
  ...
  }, __vue_inject_styles__$2, __vue_script__$2, __vue_scope_id__$2, __vue_is_functional_template__$2, __vue_module_identifier__$2, false, createInjector$1, undefined, undefined);
  ...
  /* script */
  const __vue_script__$3 = VueRawTable;
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_component__$3 = normalizeComponent$3(
  ...
  var install = function installVueRawTable(Vue) {
    if (install.installed) return;
    install.installed = true;
    Vue.component("VueRawTable", __vue_component__$3);
  }; // Create module definition for Vue.use()
  ...
  exports.VueRawTable = __vue_component__$3;
