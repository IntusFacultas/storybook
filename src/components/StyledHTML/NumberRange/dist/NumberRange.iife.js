var NumberRange = (function(exports) {
  "use strict";
  ...
  var SmallText = styled("small", props)(
    _templateObject3(),
    function(props) {
      return props.bold ? "bold" : 500;
    },
  ...
  var NInput = styled("input", props$1)(
    _templateObject$1(),
    function(props) {
  ...
  var NumberContainer = styled.div(_templateObject$2());
  var InputGroupContainer = styled.div(_templateObject2$1());
  ...
  /* script */
  const __vue_script__$2 = NumberRange;
  ...
  const __vue_inject_styles__$2 = function(inject) {
    ...
    inject("data-v-0bb8c5e3_0", {
      ...
      map: {
        version: 3,
        sources: [
          "C:\\Users\\pedro\\Documents\\Personal Projects\\GitHub\\storybook\\src\\components\\StyledHTML\\NumberRange\\src\\NumberRange.vue",
        ],
        names: [],
        mappings:
          ";AA2cA;EACA,YAAA;EACA,eAAA;AACA;AACA;EACA,+BAAA;AACA;AACA,gCAAA;AACA;;EAEA,wBAAA;EACA,SAAA;AACA;;AAEA,YAAA;AACA;EACA,0BAAA;AACA",
  ...
  var install = function installNumberRange(Vue) {
    if (install.installed) return;
    install.installed = true;
    Vue.component("NumberRange", __vue_component__$2);
  }; // Create module definition for Vue.use()
  ...
  exports.NumberRange = __vue_component__$2;
  exports.default = __vue_component__$2;

  return exports;
})({});
//# sourceMappingURL=NumberRange.iife.js.map
