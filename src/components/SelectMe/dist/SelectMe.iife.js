var SelectMe = (function () {
  ...
  var DialogButton = styled("button", dialogProps)(_templateObject$2(), function (props) {
  ...
  var NButton = styled("button", props$2)(_templateObject2$1(), function (props) {
    return props.large ? "8px 10px" : props.small ? "3px 5px" : "5px 10px";
  }, function (props) {
    return props.large ? "24px" : props.small ? "12px" : "16px";
  }, function (props) {
  ...
  var __vue_component__$2 = normalizeComponent$2({}, __vue_inject_styles__$2, __vue_script__$2, __vue_scope_id__$2, __vue_is_functional_template__$2, __vue_module_identifier__$2, false, undefined, undefined, undefined); // Import vue component
  ...
  /* script */
  const __vue_script__$3 = SelectMe;
  ...
  __vue_render__$1._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__$3 = "data-v-844281fc";
    /* module identifier */
  ...
  var install$1 = function installSelectMe(Vue) {
    if (install$1.installed) return;
    install$1.installed = true;
    Vue.component("SelectMe", __vue_component__$3);
  }; // Create module definition for Vue.use()
...
//# sourceMappingURL=SelectMe.iife.js.map
