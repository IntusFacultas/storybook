import { NInput as e } from "@intus/input";
import { NButton as t } from "@intus/button";
var n = {
  name: "select-me",
  components: { NInput: e, NButton: t },
  data: function() {
    return {
      timeout: "",
      optionSearch: "",
    ...
    hoverElement: function() {
      ...
      clearTimeout(e.timeout),
        (e.hoveredOption = e.selectOptions.filter(function(t) {
          return (
            t[e.valueAttribute] == document.activeElement.getAttribute("value")
          );
        })[0]),
      ...
      n("n-input", {
        ...
        on: {
          ...
          keydown: [
            ...
            function(t) {
              return (!t.type.indexOf("key") &&
                e._k(t.keyCode, "right", 39, t.key, ["Right", "ArrowRight"])) ||
                    ...
                    return n(
                      "li",
                      {
                        ...
                        class: {
                          ...
                          "selectme-hovered": e.isHovered(t, e.hoveredOption)
                        },
                        attrs: {
                          tabindex: "0",
                          role: "button",
        ...
        [
          n(
            ...
            [
              ...
              e.showSelected
                ? n("span", { staticClass: "select-me-ignore-me" }, [e._v("▴")])
                : n("span", { staticClass: "select-me-ignore-me" }, [e._v("▾")])
            ]
          ),
          e._v(" "),
      ...
      n(
        ...
        e._l(e.selectedOptions, function(t, r) {
          return n(
            ...
            [
              e._v("\n      " + e._s(t[e.displayAttribute]) + "\n      "),
              e.canBeEmpty || (!e.canBeEmpty && e.selectedOptions.length > 1)
                ? n(
                    "span",
                    {
...
l._withStripped = !0;
const d = (function(e, t, n, r, o, s, i, l, d, a) {
  "boolean" != typeof i && ((d = l), (l = i), (i = !1));
      ...
      (function(e, t) {
        ...
        if (!i.ids.has(e)) {
          ...
          if (
            ...
            r[e] && i.element.removeChild(r[e]),
              r.length
                ? i.element.insertBefore(t, r[e])
...
var a = function(e) {
    a.installed || ((a.installed = !0), e.component("SelectMe", d));
  },
  c = { install: a },
  p = null;
