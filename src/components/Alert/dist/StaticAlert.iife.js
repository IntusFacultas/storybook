var StaticAlert = (function (exports) {
  'use strict';
  ...
  var AlertContainer = styled("div", props)(_templateObject2(), function (props) {
    return props.theme && props.theme[props.flavor] ? props.theme[props.flavor].border.color : props.defaultTheme[props.flavor] ? props.defaultTheme[props.flavor].border.color : "#e8e8e8";
  }, function (props) {
  ...
  exports.VueStaticAlert = __vue_component__;
  exports.default = __vue_component__;

  return exports;

}({}));
//# sourceMappingURL=StaticAlert.iife.js.map
