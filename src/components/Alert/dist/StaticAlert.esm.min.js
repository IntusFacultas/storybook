...
import { AlertTheme as n } from "@intus/design-system";
function r(e, n) {
  return (
    n || (n = e.slice(0)),
    Object.freeze(
  ...
  l = {
    components: {
      AlertContainer: e("div", a)(
        ...
        function(e) {
          return e.closeable ? "cursor: pointer;" : "";
        },
        function(e) {
          return e.theme && e.theme[e.flavor]
    ...
    data: function() {
      return { showing: !0, dying: !1, theme: n };
    },
    props: {
    ...
    computed: {
      computedClass: function() {
        return this.dying && this.animated ? ["vue-alert-dying"] : [];
      }
    }
  };
const s =
  ...
  return e.showing
    ? r(
        "alert-container",
        {
          ...
          on: { click: e.closeAlert }
        },
        [
          e._t("default", [e._v("I'm an alert! Put HTML in me!")]),
          e._v(" "),
          e.closeable
            ? r("close-container", [
                r(
...
d._withStripped = !0;
const A = (function(e, n, r, t, o, a, i, l, s, c) {
  ...
  if (
    ...
    if (p.functional) {
      const e = p.render;
      p.render = function(n, r) {
        return f.call(r), e(n, r);
      };
    } else {
      const e = p.beforeCreate;
      p.beforeCreate = e ? [].concat(e, f) : [f];
    }
  return r;
})(
  ...
  function(e) {
    return (e, n) =>
      (function(e, n) {
        const r = s ? n.media || "default" : e,
          t = p[r] || (p[r] = { ids: new Set(), styles: [] });
        if (!t.ids.has(e)) {
          t.ids.add(e);
          let r = n.source;
          if (
            ...
            const e = t.ids.size - 1,
              n = document.createTextNode(r),
              o = t.element.childNodes;
            o[e] && t.element.removeChild(o[e]),
              o.length
                ? t.element.insertBefore(n, o[e])
...
var m = function(e) {
    m.installed || ((m.installed = !0), e.component("VueStaticAlert", A));
  },
  u = { install: m },
  h = null;
