...
import { NLabel, NText } from "@intus/typography";
...
var SidebarHamburgerContainer = styled("div", props)(
  _templateObject(),
  function(props) {
    return props.breakpoint;
  }
);
var SidebarContainer = styled("aside", props)(
  _templateObject2(),
  function(props) {
...
var SidebarContent = styled("div", props)(
  _templateObject4(),
  function(props) {
...
var SidebarItem = styled("li", props)(
  _templateObject6(),
  function(props) {
    return props.theme && props.theme[props.flavor]
      ? props.theme[props.flavor].color.color
...
var SidebarDropdownCarat = styled("div", props)(_templateObject8(), function(
  props
) {
  return props.disabled
    ? "rgba(0, 0, 0, 0.3)"
...
var SidebarOffsetContent = styled("div", props)(
  _templateObject9(),
  function(props) {
    return props.breakpoint;
  },
