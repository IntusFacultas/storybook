...
import e from "@intus/design-system";
import { NLabel as r, NText as t } from "@intus/typography";
import { NButton as o } from "@intus/button";
function i(n, e) {
  return (
    e || (e = n.slice(0)),
    Object.freeze(
...
var h = {
  ...
  b = n("div", h)(m(), function(n) {
    return n.breakpoint;
  }),
  g = n("aside", h)(
    u(),
    function(n) {
      return n.theme && n.theme[n.flavor]
        ? n.theme[n.flavor].background.color
        : n.defaultTheme[n.flavor]
        ? n.defaultTheme[n.flavor].background.color
        : "#f2f2f2";
    },
    function(n) {
      return n.width;
    ...
    function(n) {
      return n.bottomOffset;
    },
    function(n) {
      return n.breakpoint;
    }
  ),
  v = n("div", h)(f(), function(n) {
    return n.theme && n.theme[n.flavor]
      ? n.theme[n.flavor].color.color
      : n.defaultTheme[n.flavor]
      ? n.defaultTheme[n.flavor].color.color
      : "#222";
  }),
  x = n("div", h)(
    c(),
  ...
  w = n("li", h)(
    ...
    function(n) {
      return n.active
        ? "\n  background-color: ".concat(
            n.theme && n.theme[n.flavor]
              ? n.theme[n.flavor].background.focus
              : n.defaultTheme[n.flavor]
              ? n.defaultTheme[n.flavor].background.focus
              : "#d7d7d7",
            ";\n  "
          )
        : "";
    ...
    function(n) {
      return n.theme && n.theme[n.flavor]
        ? n.theme[n.flavor].background.hover
        : n.defaultTheme[n.flavor]
        ? n.defaultTheme[n.flavor].background.hover
        : "#d7d7d7";
    }
  ),
  k = {
    components: {
      SidebarDropdown: n("ul", h)(l()),
      SidebarDropdownCarat: n("div", h)(s(), function(n) {
        return n.disabled
          ? "rgba(0, 0, 0, 0.3)"
          : n.theme && n.theme[n.flavor]
          ? n.theme[n.flavor].color.color
  ...
  A = {
    components: {
      SidebarContainer: g,
      SidebarHamburgerContainer: b,
      SidebarTitle: v,
      SidebarContent: x,
      SidebarItemList: y,
      SidebarItem: w,
      NText: t,
      VueSidebarDropdown: k,
      NButton: o
    },
    data: function() {
    ...
    methods: {
      collapseSection: function(n) {
        var e = n.scrollHeight,
          r = n.style.transition;
        (n.style.transition = ""),
          (n.style.height = e + "px !important"),
          (n.style.padding = "0px 0px"),
      ...
      expandSection: function(n) {
        var e = n.scrollHeight;
        (n.style.height = e + "px"),
          (n.style.padding = "5px 0px"),
          n.addEventListener("transitionend", function() {
            n.removeEventListener("transitionend", this),
              "false" == n.getAttribute("data-collapsed") &&
                (n.style.height = "auto");
          }),
          n.setAttribute("data-collapsed", "false");
      },
      checkOffclick: function(n) {
        this.open &&
          this.$refs.sidebar &&
          !(function(n, e) {
            if (n.isEqualNode(e)) return !0;
            for (; (n = n.parentNode); ) if (n.isEqualNode(e)) return !0;
            return !1;
          })(n.target, this.$refs.sidebar.$el) &&
...
var E = function() {
  ...
  return r(
    "sidebar-container",
    {
      ...
      attrs: {
        flavor: n.flavor,
        "top-offset": n.topOffset,
        "bottom-offset": n.bottomOffset,
        id: "sidebar",
        width: n.width,
    ...
    [
      r(
        "sidebar-title",
        { attrs: { flavor: n.flavor } },
        [
          r("n-text", { attrs: { size: 16 } }, [n._v(n._s(n.sidebarTitle))]),
          n._v(" "),
          r(
            "sidebar-hamburger-container",
            { attrs: { width: n.width, breakpoint: n.breakpoint } },
            [
              r(
                "n-button",
                {
                  attrs: { flavor: n.flavor },
                  on: { click: n.toggleAccordion }
                },
                [n._v("☰")]
              )
            ],
      ...
      r(
        ...
        {
          ref: "content",
          attrs: { flavor: n.flavor, width: n.width, breakpoint: n.breakpoint }
        },
        [
          r(
            "sidebar-item-list",
                    ...
                    ? r(
                        ...
                        [
                          r("div", {
                            ...
                            domProps: { innerHTML: n._s(e.icon) }
                          }),
                          n._v(" "),
                          r("n-text", { attrs: { size: 13 } }, [
                            n._v(n._s(e.text))
                          ])
                        ],
                        1
...
!(function(n, e, r, t, o, i, a, s, l, d) {
  ...
  if (
    ...
    i
      ? ((c = function(n) {
          (n =
            ...
            e && e.call(this, l(n)),
            n && n._registeredComponents && n._registeredComponents.add(i);
        }),
        (p._ssrRegister = c))
      : e &&
        (c = a
    ...
    if (p.functional) {
      const n = p.render;
      p.render = function(e, r) {
        return c.call(r), n(e, r);
      };
    } else {
      const n = p.beforeCreate;
      p.beforeCreate = n ? [].concat(n, c) : [c];
    }
})(
  ...
  function(n) {
    return (n, e) =>
      (function(n, e) {
        const r = C ? e.media || "default" : n,
          t = $[r] || ($[r] = { ids: new Set(), styles: [] });
        if (!t.ids.has(n)) {
          t.ids.add(n);
          let r = e.source;
          if (
            ...
            t.element ||
              ...
              e.media && t.element.setAttribute("media", e.media),
              void 0 === T &&
            ...
            const n = t.ids.size - 1,
              e = document.createTextNode(r),
              o = t.element.childNodes;
            o[n] && t.element.removeChild(o[n]),
              o.length
                ? t.element.insertBefore(e, o[n])
  ...
  var N = null,
    _ = function() {
      var n = L[D],
        e = function(r) {
          e.installed ||
            ((e.installed = !0), r.component(n.label, n.component));
        },
        r = { install: e };
      "undefined" != typeof window
        ...
        N && N.use(r),
        (n.component.install = e);
    },
    D = 0,
    L = [
      { label: "SidebarHamburgerContainer", component: b },
      { label: "SidebarContainer", component: g },
      { label: "SidebarTitle", component: v },
      { label: "SidebarContent", component: x },
      { label: "VueSidebarDropdown", component: k },
      { label: "Sidebar", component: A },
      { label: "SidebarItem", component: w },
      { label: "SidebarItemList", component: y },
      { label: "SidebarOffsetContent", component: S }
    ];
  D < L.length;
  D++
)
...
export {
  ...
  x as SidebarContent,
  b as SidebarHamburgerContainer,
  w as SidebarItem,
  y as SidebarItemList,
  S as SidebarOffsetContent,
  v as SidebarTitle,
  k as VueSidebarDropdown
};
