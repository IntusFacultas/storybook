import { NText as e } from "@intus/typography";
import { NButton as n } from "@intus/button";
import {
  SidebarContainer as t,
  SidebarHamburgerContainer as r,
  SidebarTitle as i,
  SidebarContent as o
} from "@intus/sidebar";
var s = {
  ...
  return t(
    ...
    [
      t(
        ...
        [
          t("n-text", { attrs: { size: 16 } }, [e._v(e._s(e.sidebarTitle))]),
          e._v(" "),
          t(
...
f._withStripped = !0;
const p = (function(e, n, t, r, i, o, s, a, l, d) {
  ...
  function(e) {
    return (e, n) =>
      (function(e, n) {
        const t = a ? n.media || "default" : e,
          r = d[t] || (d[t] = { ids: new Set(), styles: [] });
        if (!r.ids.has(e)) {
          r.ids.add(e);
          let t = n.source;
          if (
...
var h = function(e) {
    h.installed || ((h.installed = !0), e.component("RawSidebar", p));
  },
  u = { install: h },
  m = null;
"undefined" != typeof window
  ? (m = window.Vue)
  : "undefined" != typeof global && (m = global.Vue),
  m && m.use(u),
  (p.install = h);
export default p;
