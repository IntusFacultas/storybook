var RawSidebar = (function() {
  ...
  var PortionMarking = styled("span", props)(
    _templateObject5(),
    function(props) {
      return props.dark
  ...
  var SidebarHamburgerContainer = styled("div", props$2)(
    _templateObject$2(),
    function(props) {
      return props.breakpoint;
    }
  );
  var SidebarContainer = styled("aside", props$2)(
    _templateObject2$2(),
    function(props) {
      return props.theme && props.theme[props.flavor]
        ? props.theme[props.flavor].background.color
  ...
  var SidebarTitle = styled("div", props$2)(_templateObject3$1(), function(
    props
  ) {
    return props.theme && props.theme[props.flavor]
      ? props.theme[props.flavor].color.color
  ...
  var SidebarContent = styled("div", props$2)(
    _templateObject4$1(),
    function(props) {
  ...
  var SidebarItemList = styled.ul(_templateObject5$1());
  var SidebarItem = styled("li", props$2)(
    _templateObject6(),
    function(props) {
      return props.theme && props.theme[props.flavor]
        ? props.theme[props.flavor].color.color
  ...
  var SidebarDropdownCarat = styled("div", props$2)(
    _templateObject8(),
    function(props) {
      return props.disabled
        ? "rgba(0, 0, 0, 0.3)"
  ...
  var SidebarOffsetContent = styled("div", props$2)(
    _templateObject9(),
    function(props) {
      return props.breakpoint;
    },
  ...
  var __vue_inject_styles__$2 = function __vue_inject_styles__(inject) {
    if (!inject) return;
    inject("data-v-ba435ac4_0", {
      source:
        "\n.sidebar-open-carat {\r\n  transform: rotate(135deg) !important;\r\n  margin-bottom: 4px;\n}\n.sidebar-icon {\r\n  display: inline-block;\n}\n.dropdown-arrow {\r\n  background-image: linear-gradient(to top right, transparent 50%, #727272 50%);\r\n  width: 0.5rem;\r\n  height: 0.5rem;\r\n  transform: rotate(135deg);\r\n  transition: 0.3s all;\r\n  display: inline-block;\n}\n.dropdown-label {\r\n  cursor: pointer;\n}\r\n",
      map: {
        version: 3,
        sources: [
          "C:\\Users\\pedro\\Documents\\Work\\Storybook\\src\\components\\Navbars\\Sidebar\\src\\Sidebar.vue"
        ],
        names: [],
        mappings:
          ";AA6dA;EACA,oCAAA;EACA,kBAAA;AACA;AACA;EACA,qBAAA;AACA;AACA;EACA,6EAAA;EACA,aAAA;EACA,cAAA;EACA,yBAAA;EACA,oBAAA;EACA,qBAAA;AACA;AACA;EACA,eAAA;AACA",
        file: "Sidebar.vue",
        sourcesContent: [
  ...
  /* script */
  const __vue_script__$3 = RawSidebar;
  ...
  const __vue_inject_styles__$3 = function(inject) {
    if (!inject) return;
    inject("data-v-42c8fe3e_0", {
      source:
        "\n.sidebar-open-carat {\r\n  transform: rotate(135deg) !important;\r\n  margin-bottom: 4px;\n}\n.sidebar-icon {\r\n  display: inline-block;\n}\n.dropdown-arrow {\r\n  background-image: linear-gradient(to top right, transparent 50%, #727272 50%);\r\n  width: 0.5rem;\r\n  height: 0.5rem;\r\n  transform: rotate(135deg);\r\n  transition: 0.3s all;\r\n  display: inline-block;\n}\n.dropdown-label {\r\n  cursor: pointer;\n}\r\n",
      map: {
        version: 3,
        sources: [
          "C:\\Users\\pedro\\Documents\\Work\\Storybook\\src\\components\\Navbars\\RawSidebar\\src\\RawSidebar.vue"
        ],
        names: [],
        mappings:
          ";AAmLA;EACA,oCAAA;EACA,kBAAA;AACA;AACA;EACA,qBAAA;AACA;AACA;EACA,6EAAA;EACA,aAAA;EACA,cAAA;EACA,yBAAA;EACA,oBAAA;EACA,qBAAA;AACA;AACA;EACA,eAAA;AACA",
        file: "RawSidebar.vue",
        sourcesContent: [
