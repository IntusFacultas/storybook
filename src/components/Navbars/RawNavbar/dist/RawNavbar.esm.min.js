import {
  NavbarContainer as t,
  NavbarTitle as n,
  NavbarContentContainer as e
} from "@intus/navbar";
import { NButton as r } from "@intus/button";
var i = {
  components: {
    NavbarContainer: t,
    NavbarTitle: n,
    NavbarContentContainer: e,
    NButton: r
  },
  data: function() {
    return {
  ...
  methods: {
    collapseSection: function(t) {
      var n = t.scrollHeight,
        e = t.style.transition;
      (t.style.transition = ""),
        (t.style.height = n + "px !important"),
        requestAnimationFrame(function() {
          (t.style.height = n + "px"),
            (t.style.transition = e),
            requestAnimationFrame(function() {
              (t.style.height = "0px"), (t.style.paddingBottom = "0px");
            });
        }),
        t.setAttribute("data-collapsed", "true");
    },
    expandSection: function(t) {
      var n = t.scrollHeight;
      (t.style.height = n + "px"),
        (t.style.paddingBottom = "5px"),
        t.addEventListener("transitionend", function() {
          t.removeEventListener("transitionend", this),
            "false" == t.getAttribute("data-collapsed") &&
              (t.style.height = "auto");
        }),
    ...
    debounce: function(t, n, e) {
      ...
      return function() {
        var i = this,
          ...
          s = e && !r;
        clearTimeout(r), (r = setTimeout(a, n));
        try {
          s && t.apply(i, o);
        } catch (t) {}
      };
    ...
    calculateDimensions: function() {
      if (void 0 !== this.$refs.content && !this.collapsed) {
        ...
        try {
          for (
            var i, o = this.$refs.content.$el.children[Symbol.iterator]();
            !(n = (i = o.next()).done);
            n = !0
          ) {
            t += i.value.scrollWidth;
          }
        } catch (t) {
          (e = !0), (r = t);
        } finally {
      ...
      void 0 !== this.$refs.container &&
        (this.open || (this.navHeight = this.$refs.container.$el.clientHeight),
...
var c = function() {
  ...
  return e(
    ...
    {
      ref: "container",
      class: t.computedNavClass,
      attrs: { flavor: t.flavor, fixed: t.fixed, collapsed: t.collapsed }
    },
    [
      e("navbar-title", { ref: "title", attrs: { tabindex: "1" } }, [
        e("div", {
          staticClass: "navbar-brand",
          domProps: { innerHTML: t._s(t.title.html) }
        }),
        t._v(" "),
        e("a", { attrs: { href: t.title.url ? t.title.url : "#" } }, [
          t._v(t._s(t.title.text))
        ])
      ]),
      t._v(" "),
      e(
        "n-button",
        {
          ...
          attrs: { tabindex: "1", flavor: t.flavor },
          on: { click: t.toggleAccordion }
        },
        [t._v("☰")]
      ),
      t._v(" "),
...
c._withStripped = !0;
const d = (function(t, n, e, r, i, o, a, s, l, c) {
  ...
  if (
    ...
    o
      ...
      : n &&
        (h = a
          ? function(t) {
              n.call(this, c(t, this.$root.$options.shadowRoot));
            }
          : function(t) {
              n.call(this, s(t));
            }),
    ...
    if (d.functional) {
      const t = d.render;
      d.render = function(n, e) {
        return h.call(e), t(n, e);
      };
    } else {
  ...
  function(t) {
    return (t, n) =>
      (function(t, n) {
        const e = o ? n.media || "default" : t,
          r = s[e] || (s[e] = { ids: new Set(), styles: [] });
        if (!r.ids.has(t)) {
          r.ids.add(t);
          let e = n.source;
          if (
            ...
            i[t] && r.element.removeChild(i[t]),
              i.length
                ? r.element.insertBefore(n, i[t])
...
var h = function(t) {
    h.installed || ((h.installed = !0), t.component("RawNavbar", d));
  },
  p = { install: h },
  f = null;
