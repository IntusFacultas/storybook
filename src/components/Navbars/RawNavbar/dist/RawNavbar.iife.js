var RawNavbar = (function (exports) {
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    }), _vm._v(" "), _vm.title.text ? _c("a", {
      attrs: {
        href: _vm.title.url ? _vm.title.url : "#"
      }
    }, [_vm._v(_vm._s(_vm.title.text))]) : _vm._e()]), _vm._v(" "), _c("n-button", {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: _vm.collapsed,
  ...
  var __vue_inject_styles__$1 = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-7dc223e3_0", {
      ...
      map: {
        ...
        "names": [],
        "mappings": ";AA8qBA;EACA,aAAA;EACA,mBAAA;EACA,YAAA;AACA;AACA;EACA,oCAAA;EACA,kBAAA;AACA;AACA;EACA,6BAAA;AACA;AACA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,WAAA;AACA",
        "file": "Navbar.vue",
  ...
  var Navbar$1 = {
    ...
    methods: {
      ...
      collapseSection: function collapseSection(element) {
        ...
        element.style.transition = "";
        element.style.height = sectionHeight + "px !important";
        element.style.paddingBottom = "0px"; // element.style.width = sectionWidth + "px !important";
        // on the next frame (as soon as the previous style change has taken effect),
        // explicitly set the element's height to its current pixel height, so we
        // aren't transitioning out of 'auto'
