var Modal = (function () {
  ...
  var NModalHeader = styled("div", props)(_templateObject3(), function (props) {
    ...
    return props.theme && props.theme[props.flavor] ? props.theme[props.flavor].color.color : props.defaultTheme[props.flavor] ? props.defaultTheme[props.flavor].color.color : "initial";
  });
  ...
  var Modal = {
    ...
    methods: {
      ...
      turnOff: function turnOff(event) {
        if (this.backgroundDismiss && !this.isDescendant(this.$refs.modal.$el, event.target)) {
          this.visible = false;
        }
      },
          ...
          [
            _c(
              ...
              [
                ...
                _c(
                  "n-modal-body",
                  { style: _vm.computedStyle, attrs: { flavor: _vm.bodyFlavor } },
                  [_vm._t("body")],
                  2
                ),
                _vm._v(" "),
