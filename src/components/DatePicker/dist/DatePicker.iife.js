var DatePicker = (function (exports) {
  ...
  var DatePicker = {
    ...
    methods: {
      confirmOrCancelManualInput: function confirmOrCancelManualInput() {
        var self = this;
        ...
        self.debounceCorrection = setTimeout(function () {
      ...
      handleManualInput: function handleManualInput(value) {
        var manualDate = moment(value);

        if (manualDate.isValid()) {
          this.lastManualInput = manualDate.clone(); // check if date is before allowed start
          ...
          this.lastManualInput = this.start ? this.start.clone() : this.currentDate.clone();
        }
      },
      open: function open() {
        this.show = true;
      ...
      [
        _c("vue-input", {
          ...
          on: {
            ...
            input: _vm.handleManualInput,
            change: _vm.confirmOrCancelManualInput,
            blur: _vm.confirmOrCancelManualInput
          }
        }),
        _vm._v(" "),
          ...
          ? _c(
              ...
              [
                ...
                _c(
                  "calendar",
                  {
                    staticClass: "monthpicker__table",
                    attrs: { "data-datepicker": _vm.name }
                  },
                  [
                    _vm.cursorDate
                      ? _c(
                          ...
                          { attrs: { "data-datepicker": _vm.name } },
                          [
                            _vm._l(_vm.shownYear.months, function(
                              monthChunk,
                              index
                            ) {
                              return _c(
                  ...
                  [
                    _vm.cursorDate
                      ? _c(
                          ...
                          { attrs: { "data-datepicker": _vm.name } },
                          [
                            _vm._l(_vm.shownYears.years, function(
                              yearChunk,
                              index
                            ) {
                              return _c(
  ...
  exports.DatePicker = __vue_component__$2;
