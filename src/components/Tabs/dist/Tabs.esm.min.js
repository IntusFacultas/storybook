...
import r from "@intus/design-system";
function n(e, r) {
  return (
    r || (r = e.slice(0)),
    Object.freeze(
...
var l = {
  ...
  s = e("nav", l)(
    a(),
    l.theme && l.theme[l.flavor]
      ? l.theme[l.flavor].border.color
      : l.defaultTheme[l.flavor]
      ? l.defaultTheme[l.flavor].border.color
      : "#dee2e6 "
  ),
  p = e.ul(t()),
  i = e("li", l)(
  ...
  return n(
    ...
    [
      n(
        "tab-list",
        { ref: "tabs" },
        e._l(e.tabs, function(r, o) {
          return n("tab-item", {
            key: o,
            attrs: { flavor: e.flavor, index: o, tab: r },
...
u._withStripped = !0;
const h = (function(e, r, n, o, t, a, l, s, p, i) {
  "boolean" != typeof l && ((p = s), (s = l), (l = !1));
  ...
  if (
    ...
    if (d.functional) {
      const e = d.render;
      d.render = function(r, n) {
        return c.call(n), e(r, n);
      };
    } else {
      const e = d.beforeCreate;
      d.beforeCreate = e ? [].concat(e, c) : [c];
    }
  return n;
})(
  ...
  function(e) {
    return (e, r) =>
      (function(e, r) {
        const n = c ? r.media || "default" : e,
          o = m[n] || (m[n] = { ids: new Set(), styles: [] });
        if (!o.ids.has(e)) {
          o.ids.add(e);
          let n = r.source;
          if (
            ...
            const e = o.ids.size - 1,
              r = document.createTextNode(n),
              t = o.element.childNodes;
            t[e] && o.element.removeChild(t[e]),
              t.length
                ? o.element.insertBefore(r, t[e])
...
var v = function(e) {
    v.installed || ((v.installed = !0), e.component("Tabs", h));
  },
  y = { install: v },
  x = null;
"undefined" != typeof window
  ? (x = window.Vue)
  : "undefined" != typeof global && (x = global.Vue),
  x && x.use(y),
  (h.install = v);
export default h;
