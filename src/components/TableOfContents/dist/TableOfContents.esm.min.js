import e from "vue-styled-components";
import { TextTheme as r } from "@intus/design-system";
function t(e) {
  return (t =
...
var c = {
  ...
  f = e.span(a()),
  d = e("nav", c)(s(), function(e) {
    return e.width ? e.width : "auto";
  }),
  u = {
    components: {
      ContentsTable: e("ul", c)(i()),
      Item: e("li", c)(
        o(),
        function(e) {
          return 10 * e.padding + 10;
        },
        function(e) {
    ...
    data: function() {
      return { titles: [], override: !1, scrollToOverride: !1 };
    },
    props: {
      width: { type: String, default: "auto" },
      flavor: { type: String, default: "" },
      queryOverride: { type: String, default: "" },
    ...
    methods: {
      toggleOverride: function() {
        ...
        try {
          for (
            var n, l = this.titles[Symbol.iterator]();
            !(e = (n = l.next()).done);
            e = !0
          ) {
            n.value.override = this.override;
          }
        } catch (e) {
          (r = !0), (t = e);
        } finally {
      ...
      scrollToEl: function(e) {
        var r =
          e.getBoundingClientRect().top + window.pageYOffset - this.offset;
        window.scrollTo({ top: r - 5, behavior: "smooth" }),
          (this.scrollToOverride = !0);
        var t = this;
        setTimeout(function() {
          setTimeout(function() {
            t.checkTitles();
          }, 100),
            (t.scrollToOverride = !1);
        }, 500),
          e.focus();
      },
      debounce: function(e, r, t) {
        var n;
        return function() {
          var l = this,
            o = arguments,
            ...
            s = t && !n;
          clearTimeout(n), (n = setTimeout(i, r)), s && e.apply(l, o);
        };
      },
      computeOverride: function(e) {
        return (
      ...
      computeScreenVisibility: function(e) {
        return (
      ...
      computeVisibility: function(e) {
        return (
          0 == e.parents.length ||
          (1 == e.directParents.length &&
            1 == e.parents.length &&
            this.computeScreenVisibility(e.directParents[0])) ||
          this.computeOverride(e) ||
          this.computeScreenVisibility(e)
        );
      },
      margined: function(e) {
        return e.visible;
      ...
      getPathTo: function(e) {
        ...
        for (var r = 0, t = e.parentNode.childNodes, n = 0; n < t.length; n++) {
          var l = t[n];
          if (l === e)
            return (
              this.getPathTo(e.parentNode) +
              "/" +
              e.tagName +
              "[" +
              (r + 1) +
          ...
          1 === l.nodeType && l.tagName === e.tagName && r++;
        }
      },
      checkIfTitle: function(e) {
        return this.queryOverride
          ? e.matches(this.queryOverride)
          : e.matches("h1, h2, h3, h4, h5, h6");
      },
      calculateTitleType: function(e) {
        return this.queryOverride
          ? e.getAttribute("data-rank")
            ...
            o = function() {
                ...
                for (
                  var a,
                    c = Array.from(e.children)
                      .filter(function(r) {
                        return -1 == l.indexOf(r) && !r.isEqualNode(e);
                      })
                      [Symbol.iterator]();
                  !(o = (a = c.next()).done);
                  o = !0
              ...
              u &&
                ...
                t.push({
                  el: e,
                  id: r.getPathTo(e),
                  titleType: r.calculateTitleType(e),
                  offset: -1,
                  visible: !1,
                  hovered: !1,
                  override: !1
                }),
                l.push(r.getPathTo(e));
            };
          n.length > 0;
      ...
      checkTitles: function() {
        ...
        if (0 != this.titles.length) {
          ...
          try {
            for (
              var o, i = this.titles.entries()[Symbol.iterator]();
              !(r = (o = i.next()).done);
              r = !0
            ) {
              var s = l(o.value, 2),
                ...
                c = s[1];
              if (
                ((c.offset = c.el.getBoundingClientRect().top),
                c.offset < 20 + this.offset && c.offset > 0)
              ) {
                var f = !0,
                  d = !1,
                  u = void 0;
                ...
                c.visible &&
                  c.el.getBoundingClientRect().bottom >=
                    (window.innerHeight ||
                      document.documentElement.clientHeight) &&
                  (this.titles[a - 1] && (this.titles[a - 1].visible = !0),
                  (c.visible = !1));
            }
          } catch (e) {
            (t = !0), (n = e);
          ...
          if (
            ...
            this.titles[0].visible = !0;
          } else if (window.innerHeight + e >= document.body.offsetHeight) {
            var w = !0,
              T = !1,
              x = void 0;
            try {
            ...
            this.titles[this.titles.length - 1].visible = !0;
          }
        }
      },
      assignChildren: function() {
        for (var e = this, r = 0; r < this.titles.length; r++) {
          var t = this.titles[r];
          t.children || (t.children = []),
            t.parents || (t.parents = []),
            t.directParents || (t.directParents = []);
          for (var n = r + 1; n < this.titles.length; n++) {
            var l = this.titles[n];
            if (!(l.titleType > t.titleType)) break;
            t.children.push(l),
              l.parents || (l.parents = []),
              l.directParents || (l.directParents = []),
              l.parents.push(t);
          }
        }
        var o = !0,
        ...
        try {
          for (
            var a,
              c = function() {
                var r = a.value;
                1 == r.parents.length && r.directParents.push(r.parents[0]),
                  0 == r.parents.length
                    ? (r.siblings = [])
                    : (r.siblings = e.titles.filter(function(e) {
                        return (
                          e.parents.filter(function(e) {
                            return e.id == r.parents[0].id;
                          }).length > 0 &&
                          e.parents.length == r.parents.length &&
                          e.id != r.id
                        );
                      }));
              },
              f = this.titles[Symbol.iterator]();
            !(o = (a = f.next()).done);
            o = !0
          )
            c();
      ...
      (this.titles = this.crawl(document.getElementsByTagName("body")[0])),
        ...
        (function() {
          function e() {
            ...
            if (
              ...
              var n,
                ...
                o = {
                  ...
                  scrollBy: e.scrollBy,
                  elementScroll: l.prototype.scroll || a,
                  ...
                  if (!0 !== c(arguments[0])) {
                    ...
                    t !== r.body
                      ? (m.call(
                          this,
                          t,
                          t.scrollLeft + l.left - n.left,
                          t.scrollTop + l.top - n.top
                        ),
            ...
            function d(r, t) {
              var n = e.getComputedStyle(r, null)["overflow" + t];
            ...
            function p(e) {
              for (; e !== r.body && !1 === u(e); ) e = e.parentNode || e.host;
              return e;
            }
            function h(r) {
              var t,
              ...
              (o = s = s > 1 ? 1 : s),
                ...
                (n = r.startX + (r.x - r.startX) * t),
                (l = r.startY + (r.y - r.startY) * t),
                r.method.call(r.scrollable, n, l),
                (n === r.x && l === r.y) ||
                  e.requestAnimationFrame(h.bind(e, r));
            }
            function m(t, n, l) {
              var s,
                c,
              ...
              t === r.body
                ? ((s = e),
                  ...
                  (d = o.scroll))
                : ((s = t), (c = t.scrollLeft), (f = t.scrollTop), (d = a)),
                h({
                  scrollable: s,
                  method: d,
                  startTime: u,
        ...
        [
          t(
            "item",
            {
              ...
              attrs: { flavor: e.flavor, tabindex: "0" },
              on: {
                click: e.toggleOverride,
                keyup: [
                  function(r) {
                    return !r.type.indexOf("key") &&
                      e._k(r.keyCode, "space", 32, r.key, [" ", "Spacebar"])
                      ? null
                      : e.toggleOverride(r);
                  },
                  function(r) {
            ...
            [
              e._v("\n      Table of Contents\n      "),
              e.override ? t("toggler", [e._v("−")]) : t("toggler", [e._v("+")])
            ],
            1
          ),
          e._v(" "),
          e._l(e.titles, function(r) {
            return t(
              "item",
              {
                key: r.id,
                class: {
                  "active-title": r.visible,
                  "margined-title": e.margined(r),
                  "visible-title": e.computeVisibility(r)
                },
                attrs: {
                  flavor: r.visible ? "MissileOrange" : e.flavor,
                  tabindex: e.computeVisibility(r) ? 0 : -1,
                  padding: r.titleType - 1
                },
                on: {
                  click: function(t) {
                    return e.scrollToEl(r.el);
                  },
                  keyup: [
                    function(t) {
...
g._withStripped = !0;
const b = (function(e, r, t, n, l, o, i, s, a, c) {
  ...
  if (
    ...
    if (f.functional) {
      const e = f.render;
      f.render = function(r, t) {
        return d.call(t), e(r, t);
      };
    } else {
  ...
  function(e) {
    return (e, r) =>
      (function(e, r) {
        const t = p ? r.media || "default" : e,
          n = m[t] || (m[t] = { ids: new Set(), styles: [] });
        if (!n.ids.has(e)) {
          n.ids.add(e);
          let t = r.source;
          if (
            ...
            l[e] && n.element.removeChild(l[e]),
              l.length
                ? n.element.insertBefore(r, l[e])
...
var y = function(e) {
    y.installed || ((y.installed = !0), e.component("TableOfContents", b));
  },
  w = { install: y },
  T = null;
"undefined" != typeof window
  ? (T = window.Vue)
  : "undefined" != typeof global && (T = global.Vue),
  T && T.use(w),
  (b.install = y);
export default b;
