var TableOfContents = (function() {
  ...
  var TableOfContents = {
    ...
    methods: {
      ...
      scrollToEl: function scrollToEl(el) {
        var y =
          el.getBoundingClientRect().top + window.pageYOffset - this.offset; // el.scrollIntoView({ behavior: "smooth", block: "start" });
  ...
  const __vue_inject_styles__ = function(inject) {
    if (!inject) return;
    inject("data-v-57f7f0c4_0", {
      source:
        "\n.visible-title {\r\n  max-height: 100px !important;\r\n  padding-bottom: 2px;\r\n  padding-top: 2px;\n}\n.margined-title {\r\n  border-left-style: solid;\r\n  border-left-width: 3px;\r\n  border-left-color: #ff7200 !important;\n}\n.active-title {\r\n  font-weight: bold;\n}\n.table-of-contents-title {\r\n  font-size: 16px;\n}\r\n",
      map: {
        version: 3,
        sources: [
          "C:\\Users\\pedro\\Documents\\Personal Projects\\GitHub\\storybook\\storybook\\src\\components\\TableOfContents\\src\\TableOfContents.vue"
        ],
        names: [],
        mappings:
          ";AAk0BA;EACA,4BAAA;EACA,mBAAA;EACA,gBAAA;AACA;AACA;EACA,wBAAA;EACA,sBAAA;EACA,qCAAA;AACA;AACA;EACA,iBAAA;AACA;AACA;EACA,eAAA;AACA",
