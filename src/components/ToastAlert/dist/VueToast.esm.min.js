...
import { AlertTheme as r } from "@intus/design-system";
function t(e, r) {
  return (
    r || (r = e.slice(0)),
    Object.freeze(
...
var s = {
  ...
  p = {
    components: {
      AlertContainer: e("div", s)(l(), function(e) {
        return e.width;
      }),
      IconContainer: e("div", s)(a()),
      AlertContent: e.div(o()),
      Alert: e("div", s)(
        n(),
        function(e) {
    ...
    methods: {
      toast: function(e) {
        ...
        var n = "This is an info toast";
        e.text && (n = e.text);
        var o = this.availableId++,
            ...
            t(
              "svg",
              {
                ...
                attrs: {
                  ...
                  height: "10",
                  width: "10",
                  stroke: e.theme[r.type] ? e.theme[r.type].color.color : "#222"
                }
              },
              [
                t("path", {
...
h._withStripped = !0;
const y = (function(e, r, t, n, o, a, l, i, s, c) {
  ...
  function(e) {
    return (e, r) =>
      (function(e, r) {
        const t = d ? r.media || "default" : e,
          n = f[t] || (f[t] = { ids: new Set(), styles: [] });
        if (!n.ids.has(e)) {
          n.ids.add(e);
          let t = r.source;
          if (
...
var u = function(e) {
    u.installed || ((u.installed = !0), e.component("VueToast", y));
  },
  v = { install: u },
  C = null;
